...
## 2026-11-15 - Lazy Filter Counts Avoid Intermediate Arrays
...
**Action:** Chain `.lazy.filter { ... }.count` to prevent the intermediate array allocation while retaining O(N) evaluation time.
