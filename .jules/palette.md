...
## 2024-05-26 - State Readout for Collapsible Custom Buttons
**Learning:** In SwiftUI, custom buttons functioning as collapsible sections (like DisclosureGroups) rely on visual cues and lack implicit state readout.
