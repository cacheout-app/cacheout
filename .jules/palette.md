...
## 2024-07-06 - Empty State Accessibility Grouping
**Learning:** VoiceOver users can find it confusing when an empty state (icon, title, subtitle) is read as disjointed fragments rather than a single unified message.
