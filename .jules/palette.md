...
## 2024-05-28 - VoiceOver for Empty States
**Learning:** VoiceOver users experience empty state views (an icon and text) as disjointed fragments if they are not grouped, making it harder to grasp the context of the empty screen.
