...
/// `suppressingAliasShadows`' probe pair (`SpaceScanner.swift:2021-2025`)
...
/// (`suppressingAliasShadows`' doc, `SpaceScanner.swift:1970-1981`), and
...
/// `SpaceScanner.swift:2021-2025`), which every KEPT
/// root reaches.
///
...
///   (`SpaceScanner.swift:2031-2034`) says so:
...
///   `suppressingAliasShadows`' doc (`SpaceScanner.swift:1970-1981`)
...
enum EphemeralTempRoots {
    ...
    static func resolve(
        ...
        // (`SpaceScannerRuntime.production` (`SpaceScanner.swift:2158`)), which
        ...
        // (`SpaceScanner.swift:2021-2025`) canonicalizes and probes it —
