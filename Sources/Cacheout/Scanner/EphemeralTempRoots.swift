...
/// `suppressingAliasShadows`' probe pair (`SpaceScanner.swift:1464-1468`)
...
/// (`suppressingAliasShadows`' doc, `SpaceScanner.swift:1413-1424`), and
...
/// `SpaceScanner.swift:1464-1468`), which every KEPT
/// root reaches.
///
...
///   (`SpaceScanner.swift:1474-1477`) says so:
...
///   `suppressingAliasShadows`' doc (`SpaceScanner.swift:1413-1424`)
...
enum EphemeralTempRoots {
    ...
    static func resolve(
        ...
        // (`SpaceScannerRuntime.production` (`SpaceScanner.swift:1601`)), which
        ...
        // (`SpaceScanner.swift:1464-1468`) canonicalizes and probes it —
