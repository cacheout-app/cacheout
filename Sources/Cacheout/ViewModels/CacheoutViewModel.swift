...
class CacheoutViewModel: ObservableObject {
    ...
    var selectedSize: Int64 {
        // ⚡ Bolt: Use lazy filter to prevent intermediate array allocation during size reduction
    ...
    var hasSelection: Bool {
        // ⚡ Bolt: Short-circuit evaluation instead of eagerly filtering the entire array
