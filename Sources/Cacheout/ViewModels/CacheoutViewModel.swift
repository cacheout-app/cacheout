...
class CacheoutViewModel: ObservableObject {
    ...
    var selectedSize: Int64 {
        // ⚡ Bolt Optimization: Use lazy filtering to prevent intermediate array allocations
    ...
    // ⚡ Bolt Optimization: Use contains(where:) to short-circuit evaluation instead of eager filter + isEmpty
