...
class CacheoutViewModel: ObservableObject {
    ...
    var selectedSize: Int64 {
        // ⚡ Bolt Optimization: Use lazy filtering to prevent intermediate array allocation during reduce
    ...
    var hasSelection: Bool {
        // ⚡ Bolt Optimization: Use contains(where:) instead of checking .isEmpty on a filtered array to short-circuit
