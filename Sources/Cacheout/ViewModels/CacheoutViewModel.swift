...
class CacheoutViewModel: ObservableObject {
    ...
    var formattedSelectedSize: String {
        Formatters.byteCount.string(fromByteCount: selectedSize)
    }
    ...
    var formattedNodeModulesTotal: String {
        Formatters.byteCount.string(fromByteCount: nodeModulesTotal)
    }
    ...
    var formattedSelectedNodeModulesSize: String {
        Formatters.byteCount.string(fromByteCount: selectedNodeModulesSize)
    }

    var totalSelectedSize: Int64 { selectedSize + selectedNodeModulesSize }

    var formattedTotalSelectedSize: String {
        Formatters.byteCount.string(fromByteCount: totalSelectedSize)
    }
