...
class CacheoutViewModel: ObservableObject {
    ...
    var selectedSize: Int64 {
        // ⚡ Bolt Optimization: Use lazy.filter to avoid allocating an intermediate array before reduction.
    ...
    var hasSelection: Bool {
        // ⚡ Bolt Optimization: Short-circuit evaluation using .contains(where:) instead of checking .isEmpty on a filtered array or calculating total size.
