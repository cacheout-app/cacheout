...
class CacheoutViewModel: ObservableObject {
    ...
    var selectedSize: Int64 {
        // ⚡ Bolt Optimization: Use lazy filtering to prevent intermediate array allocation
    ...
    var hasSelection: Bool {
        // ⚡ Bolt Optimization: Use contains(where:) to short-circuit evaluation instead of checking .isEmpty on filtered arrays
