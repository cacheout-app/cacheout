...
public final class SysctlJournal {
    ...
    private func flushState() -> Bool {
        ...
        do {
            ...
            // Remove any stale temp file first, otherwise O_EXCL will fail.
            try? FileManager.default.removeItem(at: tmpURL)

            // Securely create temp file with 0600 permissions, preventing TOCTOU.
            ...
            guard fd >= 0 else {
                logger.error("open(2) failed to securely create temp file")
                return false
            }
